...
/* FU: I don't think that we need this section.
...
/* FU: I don't think we need this section.
	qui {
...
// FU: Check what other variables we should add
	#d;
	keep	 ${key}
			 ${id}
			 
/* FU: These were listed by default:
			 a_district_id
			 a_district
			 a_kg_id
			 a_kg
