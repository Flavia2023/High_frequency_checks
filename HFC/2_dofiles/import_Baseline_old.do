...
*
*	Inputs:  "/Users/flavia_ungarelli/Dropbox/Kenya Lactation Rooms/9.SCALEUP/HFC/4_data/2_survey/0_Mock_dataset_baseline/Baseline_Survey_Lactation_Rooms_Scaleup_WIDE.csv"
*	Outputs: "/Users/flavia_ungarelli/Dropbox/Kenya Lactation Rooms/9.SCALEUP/HFC/4_data/2_survey/0_Mock_dataset_baseline/Baseline_Survey_Lactation_Rooms_Scaleup.dta"
*
*	Output by SurveyCTO July 18, 2023 4:27 PM.
...
local text_fields32 "modm_m6b_b modm_m6c_b randomdraw3 upload_picture modm_enddur modm_duration s_status_oth final_comment instanceid"
...
if _N>0 {
	...
	* label variables
	...
	label define modb_b2_whatsapp 1 "Yes" 2 "No" 3 "I don't know"
	...
	label define modd_d17f 1 "Yes" 2 "No" 3 "I don't know"
	...
	label define modd_d3_male 1 "Yes, pumped milk" 2 "Yes, breastfeeding" 3 "Both (breastfeeding and pumped milk)" 4 "None of the above" -222 "I don’t know" -999 "Prefer not to answer"
	...
	label define modd_d5a_male 1 "Yes" 0 "No" -222 "I don’t know" -999 "Prefer not to answer"
	...
	label define modd_d21a_male 1 "Yes, Manual breast pump" 2 "Yes, Electric breast pump" 3 "Both electric and manual pump" 4 "No" -222 "I don’t know" -999 "Prefer not to answer"
	...
	label define modd_d11b_male 1 "Yes, fulltime" 2 "Yes, parttime" 3 "No" -222 "I don’t know" -999 "Prefer not to answer"
	...
	label define modd_d15_male 1 "Yes, contract formally changed" 2 "Yes, had informal agreements with the head teacher/supervisor" 3 "Yes, had informal agreements with colleagues" 4 "Yes, other (specify)" 5 "No" -222 "I don’t know" -999 "Prefer not to answer"
	...
	label define modd_d22a_male 1 "Yes" 2 "No" 3 "I don't know"
	...
	label define modd_d22b_male 1 "Yes" 2 "No" 3 "I don't know"
	...
	label define modd_d22d_male 1 "Yes" 2 "No" 3 "I don't know"
	...
	label define modd_d22e_male 1 "Yes" 2 "No" 3 "I don't know"
	...
	label define modd_d22f_male 1 "Yes" 2 "No" 3 "I don't know"
	...
	label define modd_d22g_male 1 "Yes" 2 "No" 3 "I don't know"
	...
	label define modd_d22h_male 1 "Yes" 2 "No" 3 "I don't know"
	...
	label define modd_d22i_male 1 "Yes" 2 "No" 3 "I don't know"
	...
	label define modf_f7_male 1 "Strongly Agree" 2 "Agree" 3 "Disagree" 4 "Strongly Disagree" 5 "I don't know" 6 "Prefer not to answer"
	...
	label define modf_f17_male 1 "Not supportive at all" 2 "Not very supportive" 3 "Somewhat supportive" 4 "Very supportive" 5 "I don't know" 6 "I prefer not to answer"
	...
	label define modf_f18_male 1 "Not supportive at all" 2 "Not very supportive" 3 "Somewhat supportive" 4 "Very supportive" 5 "I don't know" 6 "I prefer not to answer"
	...
	label define modf_f19_male 1 "Not supportive at all" 2 "Not very supportive" 3 "Somewhat supportive" 4 "Very supportive" 5 "I don't know" 6 "I prefer not to answer"
	...
	label define modf_f4 1 "Yes" 2 "No" 3 "I don't know"
	...
	label define modg_g11 1 "Yes" 2 "No" 3 "I don't know"
	...
	label variable mdh_h1 "H1. In this school, is there a lactation room?"
	note mdh_h1: "H1. In this school, is there a lactation room?"
	label define mdh_h1 1 "Yes, there is" 2 "No, there is not"
	label values mdh_h1 mdh_h1
	...
	label define modh_h3 1 "Yes" 2 "No" 3 "I don't know"
	...
	label define modh_h6 1 "Employees asked for it" 2 "Management decided" 3 "I don't know"
	...
	label define modh_h7 1 "Yes, they breastfeed" 2 "Yes, they express milk" 3 "Yes, they both breastfeed and express milk" 4 "No" 5 "I don't know"
	...
	label define modh_h9 1 "Yes" 2 "No" 3 "I don't know"
	...
	label define modh_h10 1 "Yes" 2 "No" 3 "I don't know"
	...
	label define modh_h11 1 "Yes, it is written valid for everyone" 2 "Yes, it is a written agreement decided on a case-by-case basis" 3 "Yes, it is an oral agreement valid for everyone" 4 "Yes, it is an oral agreement decided on a case-by-case basis" 5 "No" 6 "I don’t know"
	...
	label define modi_i3 1 "Yes" 2 "No" 3 "I don't know"
	...
	label define modi_i4a 1 "Yes" 2 "No" 3 "I don't know"
	...
	label define modi_i5a 1 "Yes" 2 "No" 3 "I don't know"
	...
	label define modi_i6a 1 "Yes" 2 "No" 3 "I don't know"
	...
	label define modi_i7a 1 "Yes" 2 "No" 3 "I don't know"
	...
	label define modj_j3a 1 "Yes" 2 "No" 3 "I don't know"
	...
	label define modj_j6 1 "Yes" 2 "No" 3 "I don't know"
...
*
*   Corrections file path and filename:  /Users/flavia_ungarelli/Dropbox/Kenya Lactation Rooms/9.SCALEUP/HFC/4_data/2_survey/0_Mock_dataset_baseline/Baseline_Survey_Lactation_Rooms_Scaleup_corrections.csv
*
